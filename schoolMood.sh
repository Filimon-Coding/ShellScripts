...
open_firefox() {
    ...
    firefox https://oslomet.instructure.com/ https://chat.openai.com/ https://github.com/dashboard/ https://calendar.google.com/calendar/u/1/r/week?pli=1/ https://hioa365-my.sharepoint.com/my?id=%2Fpersonal%2Ffikal5351%5Foslomet%5Fno%2FDocuments%2FDokumenter%2FOsloMetITHele/ https://teams.microsoft.com/v2/ 2>/dev/null &
}
